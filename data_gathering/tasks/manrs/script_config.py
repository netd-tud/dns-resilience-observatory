"""Per-module configuration and logging setup for MANRS tasks."""
...
_CONFIGURED = False
CONFIG_FILE = Path(__file__).with_name("manrs.conf")
...
def load_script_config(script_path: str | Path) -> SectionProxy:
    ...
    if not parser.read(CONFIG_FILE):
        raise FileNotFoundError(f"Missing MANRS config file: {CONFIG_FILE}")
