...
class ResolverAnycastSummaryResponse(Schema):
    ...
    resolver_dohpath: Optional[str] = Field(None, description="Resolver DNS-over-HTTPS path")
    resolver_qmin: Optional[str] = Field(None, description="Resolver QMIN state")
    resolver_qmin_max_minimise_count: Optional[int] = Field(None, description="Resolver QMIN maximum minimise count")
    resolver_qmin_minimize_one_lab: Optional[int] = Field(None, description="Resolver QMIN one-label minimisation value")
    resolver_dnssec_validates: Optional[bool] = Field(None, description="Resolver DNSSEC validation result")
    ...
    spoofing_received_count: int = Field(..., description="Containing spoofing prefixes with a received result")
